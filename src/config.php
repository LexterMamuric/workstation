...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'q1dVaIm2ZBfqqWuq', // Random key for encryption
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'WorkStationDB\\project3\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'WorkStationDB\\project3\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-620aecad-8b27-48fa-89eb-3a65b7f85c7c", // Export folder
    ...
    "ADMIN_USER_NAME" => "admin@admin.com", // Administrator user name
