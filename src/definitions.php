...
return [
    ...
    // Tables
    "workstation" => \DI\create(Workstation::class),
    "user" => \DI\create(User::class),
    "component_type" => \DI\create(ComponentType::class),
    "component_category" => \DI\create(ComponentCategory::class),
    "component_make" => \DI\create(ComponentMake::class),
    "component_model" => \DI\create(ComponentModel::class),
    "component_display_size" => \DI\create(ComponentDisplaySize::class),
    "component_keyboard_layout" => \DI\create(ComponentKeyboardLayout::class),
];
