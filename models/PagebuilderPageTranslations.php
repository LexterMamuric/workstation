...
/**
 * Table class for pagebuilder__page_translations
 */
class PagebuilderPageTranslations extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "pagebuilder__page_translations";
        $this->TableName = 'pagebuilder__page_translations';
        $this->TableType = "TABLE";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "`pagebuilder__page_translations`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // page_id
        $this->page_id = new DbField(
            $this, // Table
            'x_page_id', // Variable name
            'page_id', // Name
            '`page_id`', // Expression
            '`page_id`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`page_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->page_id->InputTextType = "text";
        $this->page_id->Nullable = false; // NOT NULL field
        $this->page_id->Required = true; // Required field
        $this->page_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->page_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['page_id'] = &$this->page_id;

        // locale
        $this->locale = new DbField(
            $this, // Table
            'x_locale', // Variable name
            'locale', // Name
            '`locale`', // Expression
            '`locale`', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`locale`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->locale->InputTextType = "text";
        $this->locale->Nullable = false; // NOT NULL field
        $this->locale->Required = true; // Required field
        $this->locale->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->_route->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pagebuilder__page_translations`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("pagebuilderpagetranslationslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "pagebuilderpagetranslationsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "pagebuilderpagetranslationsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "pagebuilderpagetranslationsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PagebuilderPageTranslationsView";
            case Config("API_ADD_ACTION"):
                return "PagebuilderPageTranslationsAdd";
            case Config("API_EDIT_ACTION"):
                return "PagebuilderPageTranslationsEdit";
            case Config("API_DELETE_ACTION"):
                return "PagebuilderPageTranslationsDelete";
            case Config("API_LIST_ACTION"):
                return "PagebuilderPageTranslationsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("pagebuilderpagetranslationsview", $parm);
        } else {
            $url = $this->keyUrl("pagebuilderpagetranslationsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "pagebuilderpagetranslationsadd?" . $parm;
        } else {
            $url = "pagebuilderpagetranslationsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pagebuilderpagetranslationsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pagebuilderpagetranslationslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pagebuilderpagetranslationsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pagebuilderpagetranslationslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("pagebuilderpagetranslationsdelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "PagebuilderPageTranslationsList";
    ...
    public function renderListRow()
    {
        ...
        $this->page_id->ViewValue = FormatNumber($this->page_id->ViewValue, $this->page_id->formatPattern());
    ...
    public function renderEditRow()
    {
        ...
        // page_id
        $this->page_id->setupEditAttributes();
        $this->page_id->EditValue = $this->page_id->CurrentValue;
        $this->page_id->PlaceHolder = RemoveHtml($this->page_id->caption());
        if (strval($this->page_id->EditValue) != "" && is_numeric($this->page_id->EditValue)) {
            $this->page_id->EditValue = FormatNumber($this->page_id->EditValue, null);
        }

        // locale
        $this->locale->setupEditAttributes();
        if (!$this->locale->Raw) {
            $this->locale->CurrentValue = HtmlDecode($this->locale->CurrentValue);
        }
        $this->locale->EditValue = $this->locale->CurrentValue;
        $this->locale->PlaceHolder = RemoveHtml($this->locale->caption());
