 ...
 * Page class
 */
class WorkstationAdd extends Workstation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WorkstationAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "workstationadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "workstationview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Workstation_Name
        $this->Workstation_Name->setDbValueDef($rsnew, $this->Workstation_Name->CurrentValue, null, false);

        // Workstation_Remark
        $this->Workstation_Remark->setDbValueDef($rsnew, $this->Workstation_Remark->CurrentValue, null, false);
        ...
        // User_Employee_Number
        $this->User_Employee_Number->setDbValueDef($rsnew, $this->User_Employee_Number->CurrentValue, null, false);

        // User_Phone_Number
        $this->User_Phone_Number->setDbValueDef($rsnew, $this->User_Phone_Number->CurrentValue, null, false);
        ...
        // Address_Zipcode
        $this->Address_Zipcode->setDbValueDef($rsnew, $this->Address_Zipcode->CurrentValue, null, false);
        ...
        // Component_Type
        $this->Component_Type->setDbValueDef($rsnew, $this->Component_Type->CurrentValue, null, false);

        // Component_Category
        $this->Component_Category->setDbValueDef($rsnew, $this->Component_Category->CurrentValue, null, false);

        // Component_Make
        $this->Component_Make->setDbValueDef($rsnew, $this->Component_Make->CurrentValue, null, false);

        // Component_Model
        $this->Component_Model->setDbValueDef($rsnew, $this->Component_Model->CurrentValue, null, false);

        // Component_Serial_Number
        $this->Component_Serial_Number->setDbValueDef($rsnew, $this->Component_Serial_Number->CurrentValue, null, false);

        // Component_Display_Size
        $this->Component_Display_Size->setDbValueDef($rsnew, $this->Component_Display_Size->CurrentValue, null, false);

        // Component_Keyboard_Layout
        $this->Component_Keyboard_Layout->setDbValueDef($rsnew, $this->Component_Keyboard_Layout->CurrentValue, null, false);

        // Component_Type1
        $this->Component_Type1->setDbValueDef($rsnew, $this->Component_Type1->CurrentValue, null, false);

        // Component_Category1
        $this->Component_Category1->setDbValueDef($rsnew, $this->Component_Category1->CurrentValue, null, false);

        // Component_Make1
        $this->Component_Make1->setDbValueDef($rsnew, $this->Component_Make1->CurrentValue, null, false);

        // Component_Model1
        $this->Component_Model1->setDbValueDef($rsnew, $this->Component_Model1->CurrentValue, null, false);

        // Component_Serial_Number1
        $this->Component_Serial_Number1->setDbValueDef($rsnew, $this->Component_Serial_Number1->CurrentValue, null, false);

        // Component_Display_Size1
        $this->Component_Display_Size1->setDbValueDef($rsnew, $this->Component_Display_Size1->CurrentValue, null, false);

        // Component_Keyboard_Layout1
        $this->Component_Keyboard_Layout1->setDbValueDef($rsnew, $this->Component_Keyboard_Layout1->CurrentValue, null, false);

        // Component_Type2
        $this->Component_Type2->setDbValueDef($rsnew, $this->Component_Type2->CurrentValue, null, false);

        // Component_Category2
        $this->Component_Category2->setDbValueDef($rsnew, $this->Component_Category2->CurrentValue, null, false);

        // Component_Make2
        $this->Component_Make2->setDbValueDef($rsnew, $this->Component_Make2->CurrentValue, null, false);

        // Component_Model2
        $this->Component_Model2->setDbValueDef($rsnew, $this->Component_Model2->CurrentValue, null, false);

        // Component_Serial_Number2
        $this->Component_Serial_Number2->setDbValueDef($rsnew, $this->Component_Serial_Number2->CurrentValue, null, false);

        // Component_Display_Size2
        $this->Component_Display_Size2->setDbValueDef($rsnew, $this->Component_Display_Size2->CurrentValue, null, false);

        // Component_Keyboard_Layout2
        $this->Component_Keyboard_Layout2->setDbValueDef($rsnew, $this->Component_Keyboard_Layout2->CurrentValue, null, false);
