...
class PersonalAccessTokens extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // tokenable_type
        $this->tokenable_type = new DbField(
            $this, // Table
            'x_tokenable_type', // Variable name
            'tokenable_type', // Name
            '`tokenable_type`', // Expression
            '`tokenable_type`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tokenable_type`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tokenable_type->InputTextType = "text";
        $this->tokenable_type->Nullable = false; // NOT NULL field
        $this->tokenable_type->Required = true; // Required field
        $this->tokenable_type->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['tokenable_type'] = &$this->tokenable_type;

        // tokenable_id
        $this->tokenable_id = new DbField(
            $this, // Table
            'x_tokenable_id', // Variable name
            'tokenable_id', // Name
            '`tokenable_id`', // Expression
            '`tokenable_id`', // Basic search expression
            21, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tokenable_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tokenable_id->InputTextType = "text";
        ...
        $this->tokenable_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->_token->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['token'] = &$this->_token;

        // abilities
        $this->abilities = new DbField(
            $this, // Table
            'x_abilities', // Variable name
            'abilities', // Name
            '`abilities`', // Expression
            '`abilities`', // Basic search expression
            201, // Type
            65535, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`abilities`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->abilities->InputTextType = "text";
        $this->abilities->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['abilities'] = &$this->abilities;

        // last_used_at
        $this->last_used_at = new DbField(
            $this, // Table
            'x_last_used_at', // Variable name
            'last_used_at', // Name
            '`last_used_at`', // Expression
            CastDateFieldForLike("`last_used_at`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
            '`last_used_at`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->last_used_at->InputTextType = "text";
        $this->last_used_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->last_used_at->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("personalaccesstokensview", $parm);
        } else {
            $url = $this->keyUrl("personalaccesstokensview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "personalaccesstokensadd?" . $parm;
        } else {
    ...
    {
        $url = $this->keyUrl("personalaccesstokensedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("personalaccesstokenslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("personalaccesstokensadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("personalaccesstokenslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("personalaccesstokensdelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "PersonalAccessTokensList";
    ...
    public function renderEditRow()
    {
        ...
        $this->last_used_at->EditValue = FormatDateTime($this->last_used_at->CurrentValue, $this->last_used_at->formatPattern());
