 ...
 * Page class
 */
class WorkstationView extends Workstation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WorkstationView";
    ...
    // CSS class/style
    public $CurrentPageName = "workstationview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "workstationlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "workstationlist"; // No matching record, return to list
                    } else {
