...
$Page->showMessage();
?>
<form name="fworkstationadd" id="fworkstationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<div class="accordion ew-accordion" id="accordion_WorkstationAdd"><!-- multi-page accordion -->
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Type"
        <?php } ?>
...
<?php if (!$Page->Component_Type->IsNativeSelect) { ?>
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Type", selectId: "fworkstationadd_x_Component_Type" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Type?.lookupOptions.length) {
        options.data = { id: "x_Component_Type", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Type", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Category"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Category", selectId: "fworkstationadd_x_Component_Category" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Category?.lookupOptions.length) {
        options.data = { id: "x_Component_Category", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Category", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Make"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Make", selectId: "fworkstationadd_x_Component_Make" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Make?.lookupOptions.length) {
        options.data = { id: "x_Component_Make", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Make", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Model"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Model", selectId: "fworkstationadd_x_Component_Model" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Model?.lookupOptions.length) {
        options.data = { id: "x_Component_Model", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Model", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Type1"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Type1", selectId: "fworkstationadd_x_Component_Type1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Type1?.lookupOptions.length) {
        options.data = { id: "x_Component_Type1", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Type1", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_workstation_Component_Category1">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Category1"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Category1", selectId: "fworkstationadd_x_Component_Category1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Category1?.lookupOptions.length) {
        options.data = { id: "x_Component_Category1", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Category1", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_workstation_Component_Make1">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Make1"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Make1", selectId: "fworkstationadd_x_Component_Make1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Make1?.lookupOptions.length) {
        options.data = { id: "x_Component_Make1", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Make1", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Display_Size1"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Display_Size1", selectId: "fworkstationadd_x_Component_Display_Size1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Display_Size1?.lookupOptions.length) {
        options.data = { id: "x_Component_Display_Size1", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Display_Size1", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Keyboard_Layout1"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Keyboard_Layout1", selectId: "fworkstationadd_x_Component_Keyboard_Layout1" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Keyboard_Layout1?.lookupOptions.length) {
        options.data = { id: "x_Component_Keyboard_Layout1", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Keyboard_Layout1", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Type2"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Type2", selectId: "fworkstationadd_x_Component_Type2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Type2?.lookupOptions.length) {
        options.data = { id: "x_Component_Type2", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Type2", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Category2"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Category2", selectId: "fworkstationadd_x_Component_Category2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Category2?.lookupOptions.length) {
        options.data = { id: "x_Component_Category2", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Category2", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Make2"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Make2", selectId: "fworkstationadd_x_Component_Make2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Make2?.lookupOptions.length) {
        options.data = { id: "x_Component_Make2", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Make2", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Model2"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Model2", selectId: "fworkstationadd_x_Component_Model2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Model2?.lookupOptions.length) {
        options.data = { id: "x_Component_Model2", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Model2", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Display_Size2"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Display_Size2", selectId: "fworkstationadd_x_Component_Display_Size2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Display_Size2?.lookupOptions.length) {
        options.data = { id: "x_Component_Display_Size2", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Display_Size2", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="fworkstationadd_x_Component_Keyboard_Layout2"
        <?php } ?>
        data-table="workstation"
...
<script>
loadjs.ready("fworkstationadd", function() {
    var options = { name: "x_Component_Keyboard_Layout2", selectId: "fworkstationadd_x_Component_Keyboard_Layout2" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fworkstationadd.lists.Component_Keyboard_Layout2?.lookupOptions.length) {
        options.data = { id: "x_Component_Keyboard_Layout2", form: "fworkstationadd" };
    } else {
        options.ajax = { id: "x_Component_Keyboard_Layout2", form: "fworkstationadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php if (!$Page->isConfirm()) { // Confirm page ?>
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fworkstationadd" data-ew-action="set-action" data-value="confirm"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fworkstationadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
<?php } else { ?>
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fworkstationadd"><?= $Language->phrase("ConfirmBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="submit" form="fworkstationadd" data-ew-action="set-action" data-value="cancel"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
