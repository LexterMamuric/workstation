...
use App\Http\Controllers\ComponentMakeController;
...
Route::prefix('/')
    ...
    ->group(function () {
        ...
        Route::resource(
            ...
            ComponentCategoryController::class
        );
        Route::resource('component-makes', ComponentMakeController::class);
        Route::resource('component-types', ComponentTypeController::class);
        Route::resource('component-models', ComponentModelController::class);
    });
